...
public class Assumpsit {
    ...
    public boolean equals(Object that) {
        ...
        Assumpsit other = (Assumpsit) that;
    ...
    public Assumpsit(Integer fId, String assStarttime) {
        this.fId = fId;
    ...
    public Assumpsit(String assId, Integer fId, String uId, String assStarttime) {
        this.assId = assId;
        this.fId = fId;
        this.uId = uId;
        this.assStarttime = assStarttime;
